...
class MainViewController : UIViewController {
    ...
    func refreshNowPlaying() {
        ...
        let url = NSURL(string: "http://radio.maybreak.com/actions/recentlyPlayed.php?station=" + self.currentChannel!.identifier);
    ...
    func getAlbumArt(artist: String, album: String) {
        ...
        let baseUrl: String = "http://radio.maybreak.com/actions/lastfm.php?method=album.getInfo&artist=" + artist + "&album=" + album;
